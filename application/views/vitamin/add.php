            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form role="form" data-parsley-validate="" class="form-horizontal form-label-left" action="<?php echo base_url() ?>master/add_process_vitamin" method="post">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" min="0" id="jenis_vitamin" val name="jenis_vitamin" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div> 
                             <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="date" id="tanggal" val name="tanggal" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div> 
